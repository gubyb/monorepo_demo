...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net/ml/models/staging-my_mlops_project-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net/ml/models/prod-my_mlops_project-model). 
